...
const info_gb_kinetik = () => {

    return(
	<div className="flex my-20 ml-[300px] font-medium text-xl bg-lightblue h-80 w-[1500px] px-5 py-5 rounded-lg">
        Seseorang dengan gaya belajar tactile atau kinestetik lebih banyak belajar dengan melakukan sesuatu (fisik) dan menyentuh, biasanya menggunakan gerakan fisik untuk memahami dan mengingat sesuatu. <br />
            ...
            Mereka lebih mengingat sesuatu yang mereka lakukan dibandingkan dengan sesuatu yang mereka lihat atau dengar. <br /> <br />
    </div>
    );
}

export default info_gb_kinetik;