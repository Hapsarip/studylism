    ...
    <div>
      ...
      <div className="flex w-1/2 mx-auto divide-x-2 gap-10 h-screen pt-20 items-center">
          ...
          <div className="w-full grid grid-cols-7 font-medium">
            {days.map((day, index) => {
              return (
                <h1
                  key={index}
                  className="h-14 w-14 grid place-content-center text-sm text-center"
                >
                  {day}
                </h1>
              );
        ...
        <div className="h-96 w-96 px-5 py-5 bg-lightblue rounded-lg items-center">
          <div className="flex justify-between">
            <div>
              <h1 className="font-medium text-2xl">Today Task</h1>
              {selectDate.toDate().toDateString()}
            </div>
            <div className="font-medium text-xl">
              <div>Progress</div>
              <h1>{loading || isNaN(progress) ? 0 : progress * 100}%</h1>
            </div>
          </div>
          <button
